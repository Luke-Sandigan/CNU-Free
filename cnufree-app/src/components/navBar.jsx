    ...
    <div className="w-full ">
        ...
        <div className=" flex items-center justify-between h-[61px]">  
          ...
          <div className="items-center hidden sm:flex gap-1">
            ...
            <button  className="hover:bg-[#111827be] hover:shadow-[0_0_30px_rgba(168,85,247,0.8)] hover:scale-105 py-2 px-4  text-[15px] bg-[#111827] font-bold rounded-[5px] text-white px-4  mr-[10px] transition-all duration-300 ease-in-out "> Get Started </button>
          </div>
        <button className="block sm:hidden pr-5" onClick={()=> setIsOpen(!isOpen)}>  <Menu /> </button>
          ...
          <div className={`${isOpen ? "block" : "hidden"} md:hidden bg-[#111827] `}>
            ...
            <a href="/ " className="bg-[#111827] block text-[#ffffff] border-b-2 border-transparent hover:bg-[#D6EAC3] transition-all duration-300 ease-in-out  p-[5px]  "> Create Schedule </a>
          </div>
      </motion.nav> 
