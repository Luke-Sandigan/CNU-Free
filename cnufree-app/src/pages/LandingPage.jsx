        ...
        <div className="">
            ...
            <section className=" overflow-hidden-[calc(100vh-61.6px)] flex flex-col items-center justify-center">
                ...
                <div className="flex flex-col flex-auto items-center justify-center text-center max-w-2xl">
                    ...
                    <button onClick={() => navigate("/SignInPage")} className="hover:bg-[#D6EAC3] transition-all duration-300 ease-in-out m-10 border-2 flex gap-2 py-[10px] px-[15px] font-bold rounded-[8px]  bg-[#FCE034] hover:bg-[#5A98E6] " > Get Started     <ChevronLast /> </button>
                </div>
